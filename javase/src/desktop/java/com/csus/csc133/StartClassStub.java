 ...
 * @author Shai Almog
 */
public class StartClassStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "StartClass";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new StartClassStub());
    }
